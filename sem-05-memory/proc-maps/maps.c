...
int main() {
    ...
    printf("Process started. Press enter to continue.\n");
    fgetc(stdin);
    ...
    // combine this addresses output with /proc/<pid>/maps output
    // and sort using sort.py
    ...
    printf("Memory acquired. Press enter to continue.\n");
    fgetc(stdin);
    ...
    printf("Memory released. Press enter to continue.\n");
    fgetc(stdin);
    return 0;
}
